...
if __name__ == '__main__':
	...
	training_files = ['/E:/ASSIGNMENTS/Assignment_Fariza/recommendation/training_new/' + pID + '-ws-training-new.xml' for pID in patients]
	testing_files = ['/E:/ASSIGNMENTS/Assignment_Fariza/recommendation/OhioT1DM/testing/' + pID + '-ws-testing.xml' for pID in patients]
	validation_files = ['/E:/ASSIGNMENTS/Assignment_Fariza/recommendation/OhioT1DM/validation/' + pID + '-ws-validation.xml' for pID in patients]
